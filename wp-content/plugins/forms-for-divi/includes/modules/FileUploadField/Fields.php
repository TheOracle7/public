...
class Fields
{
    ...
    public function get_defaults()
    {
        $defaults = [
            ...
            'upload_limit'            => 'off',
            'upload_limit_value'      => '300',
            'upload_limit_message'    => 'Upload a maximum file size of x.',
        ];
    ...
    public function get_fields()
    {
        ...
        $fields += $this->container['divi_validation_fields']->set_upload_limit($this);
    ...
    public function general_fields()
    {
        ...
        $fields['label'] = [
            'label'       => esc_html__('File', 'et_builder'),
            'type'        => 'text',
            'tab_slug'    => 'general',
            'toggle_slug' => 'main',
        ...
        $fields['allowed_file_extensions'] = [
            'label'       => esc_html__('Allowed File Extensions', 'et_builder'),
            'type'        => 'text',
            'tab_slug'    => 'general',
            'toggle_slug' => 'main',
            'description' => esc_html__('Enter the allowed file extensions for file uploads. This will limit the type of files a user may upload. Separated with commas (i.e. jpg, gif, png, pdf)', 'et_builder'),
            'show_if'     => [],
            'default'     => $this->get_default('allowed_file_extensions'),
        ];
