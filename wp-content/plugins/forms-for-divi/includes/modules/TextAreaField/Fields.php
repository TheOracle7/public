...
class Fields
{
    ...
    public function get_selectors()
    {
        return [
            'field'     => [
                'selector' => "%%order_class%% textarea",
                'label'    => 'Text Field',
            ],
            'container' => [
                'selector' => "%%order_class%% .mdc-text-field--textarea",
                'label'    => 'Container',
            ],
        ];
    }
    ...
    public function general_fields()
    {
        ...
        $fields['rows'] = [
            ...
            'tab_slug'       => 'general',
            'toggle_slug'    => 'main',
            'description'    => esc_html__('Set the number of rows for the paragraph text.', 'et_builder'),
            'show_if'        => [],
            'allowed_units'  => [''],
            'default_unit'   => '',
            'default'        => $this->get_default('rows'),
        ];
