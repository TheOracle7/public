...
class ConsentField extends ET_Builder_Module
{
    public  $slug = 'wpt_form_consent_field' ;
    ...
    protected  $module_credits = array(
        'module_uri' => 'https://wptools.app/wordpress-plugin/divi-form-builder-with-material-design/?utm_source=consent-field&utm_medium=divi-module&utm_campaign=divi-forms&utm_content=module-credits',
        'author'     => 'WP Tools (7-day FREE Trial)',
        'author_uri' => 'https://wptools.app/wordpress-plugin/divi-form-builder-with-material-design/?utm_source=consent-field&utm_medium=divi-module&utm_campaign=divi-forms&utm_content=module-credits',
    ) ;
    /**
     * init divi module *
     */
    ...
    {
        $this->name = esc_html__( 'Consent - MD', '' );
        $this->icon_path = $this->container['plugin_dir'] . '/resources/images/consent.svg';
    }
    ...
    public function render( $attrs, $content = null, $render_slug = null )
    {
        ...
        $default = $this->container['divi']->get_prop_value( $this, 'default' ) == 'on';
        $helper_text = $this->container['divi']->get_prop_value( $this, 'helper_text' );
        $consent_field = $this->container['consent_field']->set_name( $name )->set_label( $label )->set_default( $default )->set_helper_text( $helper_text );
        ...
        if ( $field_required ) {
            ...
            $consent_field->add_constraint( 'required', [
                'error_message' => $field_required_message,
            ] );
            $consent_field->set_is_required( true );
        }
        
        return $consent_field->html();
    }
